...
public class Rope : MonoBehaviour {
	...
	void Start () {
		...
		Rigidbody prevChild = rb;
		for (int i = 0; i<childCount; i++) {
			Transform t = transform.GetChild (0);
			t.parent = null;

//			ConfigurableJoint hinge = t.gameObject.AddComponent<ConfigurableJoint> ();
//			hinge.connectedBody = prevChild;
//
...
//
//			hinge.angularXMotion = ConfigurableJointMotion.Limited;
//			hinge.angularYMotion = ConfigurableJointMotion.Limited;
//			hinge.angularZMotion = ConfigurableJointMotion.Limited;
...
//			CharacterJoint hinge = t.gameObject.AddComponent<CharacterJoint> ();
//			hinge.connectedBody = prevChild;
//
//			hinge.enableCollision = true;
//			hinge.enablePreprocessing = false;
			...
			prevChild =  t.gameObject.GetComponent<Rigidbody> ();

			PhysicsRopeNode ropeNode = t.gameObject.AddComponent<PhysicsRopeNode> ();
			ropeNode.joint = hinge;
			ropeNode.maxDistance = maxDistance;
			ropeNode.offset = offset;
		}
	}
...
//		Debug.Log(Vector3.Distance(transform.position,target.position)*resolution);
